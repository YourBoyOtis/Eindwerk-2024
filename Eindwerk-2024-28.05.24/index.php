...
<main>
    <section class="hero">
        ...
        <a href="products.php" class="btn-primary">Bekijk Producten</a>
    </section>
    ...
    <section class="latest-news">
        ...
        <article>
            ...
            <p>Bekijk de nieuwste schema's voor onze gitaarworkshops en schrijf je in. Leer van de beste in de industrie en verbeter je vaardigheden.</p>
        </article>
    </section>
</main>
